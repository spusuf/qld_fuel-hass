...
# Start with only the fuels you actually want live
...
def publish_result(sensor_entity_id, fuel_key, fuel_id, fuel_label, result, radius_km):
...
def recalc_all(radius_km=DEFAULT_RADIUS_KM):
    ...
    for fuel_key in ENABLED_FUELS:
        ...
        publish_result(sensor_entity_id, fuel_key, fuel_id, fuel_label, best, radius_km)
